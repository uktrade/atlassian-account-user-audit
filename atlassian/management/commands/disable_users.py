...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        # default_last_active_date = ((datetime.today() - relativedelta(months=3)).date()).strftime('%d-%m-%Y')
        # parser.add_argument('--desired-last-active-date',default=default_last_active_date,type=str)
