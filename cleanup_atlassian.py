...
THREE_MONTHS_AGO = (
    (datetime.now() - relativedelta(months=3)).replace(tzinfo=UTC).isoformat()
)
...
def cleanup(org_id, api_key, last_active=THREE_MONTHS_AGO, reason=REASON):
    """
    ...
    :param reason: reason for this user account being disabled
    """
